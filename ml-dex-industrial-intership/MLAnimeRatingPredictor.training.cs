    ...
    public partial class MLAnimeRatingPredictor
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"name",outputColumnName:@"name")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"name",@"genre",@"type",@"episodes",@"members"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=13,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"rating",FeatureColumnName=@"Features"}));
