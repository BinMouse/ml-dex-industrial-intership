    ...
    public partial class MLAnimeRatingPredictor
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"type", @"type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"episodes", @"episodes"),new InputOutputColumnPair(@"members", @"members")}))      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"type",@"episodes",@"members",@"name",@"genre"}))      
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=2051,NumberOfIterations=1230,MinimumExampleCountPerLeaf=20,LearningRate=0.02474227866347327,LabelColumnName=@"rating",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.15817028846133038,FeatureFraction=0.9703430301844607,L1Regularization=1.2574797679216817E-09,L2Regularization=0.6034872027197855},MaximumBinCountPerFeature=302}));
